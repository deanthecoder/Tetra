...
[TestFixture]
public class EmitGlslTests : TestsBase
{
    ...
    public void EmitOneSmallStepCode(int x, int y, double r, double g, double b, double a)
    {
        ...
        var codeWithHeader = GetGlslCodeWithShaderToyHeader(code);
    ...
    [TestCase(320, 240, 0.0, 0.0, 0.0, 0.0)]
    [TestCase(639, 479, 0.0, 0.0, 0.0, 0.0)]
    public void EmitStartCode(int x, int y, double r, double g, double b, double a)
    {
        var code = ProjectDir.GetDir("Examples").GetFile("Start.glsl").ReadAllText();
        var codeWithHeader = GetGlslCodeWithShaderToyHeader(code);
    ...
    [TestCase(320, 240, 0.0, 0.0, 0.0, 0.0)]
    [TestCase(639, 479, 0.0, 0.0, 0.0, 0.0)]
    public void EmitSpaceJockeyCode(int x, int y, double r, double g, double b, double a)
    {
        var code = ProjectDir.GetDir("Examples").GetFile("SpaceJockey.glsl").ReadAllText();
        var codeWithHeader = GetGlslCodeWithShaderToyHeader(code);
    ...
    private static StringBuilder GetGlslCodeWithShaderToyHeader(string code)
    {
